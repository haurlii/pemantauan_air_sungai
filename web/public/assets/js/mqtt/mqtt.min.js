...
var mqtt = (() => {
  ...
  function Jg() {
    !xr ||
      !Jt ||
      ((xr = !1),
      Jt.length ? (bt = Jt.concat(bt)) : (Di = -1),
      bt.length && Bl());
  }
  function Bl() {
    if (!xr) {
  ...
  function ji(t) {
    ...
    return (
      t && ((i = i - t[0]), (n = n - t[1]), n < 0 && (i--, (n += ys))), [i, n]
    );
  }
  function wt() {
    return $u;
  ...
  function Xg() {
    ...
    function g(y) {
      for (
        var w, E = y.length, S = E % 3, I = [], B = 16383, R = 0, U = E - S;
        R < U;
        R += B
      )
  ...
  function ey() {
    ...
    function g(p) {
      let u = p.length < 0 ? 0 : S(p.length) | 0,
        f = o(u);
    ...
    (s.isBuffer = function (u) {
      ...
      (s.compare = function (u, f) {
        ...
        let b = u.length,
          A = f.length;
        for (let T = 0, k = Math.min(b, A); T < k; ++T)
          if (u[T] !== f[T]) {
            (b = u[T]), (A = f[T]);
            break;
          }
    ...
    (s.prototype.readUintLE = s.prototype.readUIntLE =
      ...
      (s.prototype.readFloatLE = function (u, f) {
        return (
          (u = u >>> 0), f || ge(u, 4, this.length), e.read(this, u, !0, 23, 4)
        );
      }),
      (s.prototype.readFloatBE = function (u, f) {
        return (
          (u = u >>> 0), f || ge(u, 4, this.length), e.read(this, u, !1, 23, 4)
        );
      }),
      (s.prototype.readDoubleLE = function (u, f) {
        return (
          (u = u >>> 0), f || ge(u, 8, this.length), e.read(this, u, !0, 52, 8)
        );
      }),
      (s.prototype.readDoubleBE = function (u, f) {
        return (
          (u = u >>> 0), f || ge(u, 8, this.length), e.read(this, u, !1, 52, 8)
        );
      });
    ...
    (s.prototype.writeDoubleLE = function (u, f, b) {
      ...
      (s.prototype.fill = function (u, f, b, A) {
        ...
        if (typeof u == "number") for (T = f; T < b; ++T) this[T] = u;
          ...
          let k = s.isBuffer(u) ? u : s.from(u, A),
            $ = k.length;
          if ($ === 0)
            throw new TypeError(
    ...
    function jg(p, u, f) {
      Or(u, "offset"),
        (p[u] === void 0 || p[u + f] === void 0) && li(u, p.length - (f + 1));
    }
      ...
      if (p > f || p < u) {
        ...
        throw (
          (T > 3
            ...
            : ($ = `>= ${u}${k} and <= ${f}${k}`),
          new kr.ERR_OUT_OF_RANGE("value", $, p))
        );
      }
      jg(b, A, T);
    }
    function Or(p, u) {
      if (typeof p != "number")
        throw new kr.ERR_INVALID_ARG_TYPE(u, "number", p);
    }
    function li(p, u, f) {
      throw Math.floor(p) !== p
        ? (Or(p, f), new kr.ERR_OUT_OF_RANGE(f || "offset", "an integer", p))
        : u < 0
        ? new kr.ERR_BUFFER_OUT_OF_BOUNDS()
        : new kr.ERR_OUT_OF_RANGE(
            f || "offset",
            `>= ${f ? 1 : 0} and <= ${u}`,
            p
          );
...
`;
  ...
  var Se = M((VA, ef) => {
    ...
    me(
      "ERR_INVALID_ARG_TYPE",
      (t, e, r) => {
        Zt(typeof t == "string", "'name' must be a string"),
          Array.isArray(e) || (e = [e]);
        let i = "The ";
        t.endsWith(" argument")
          ? (i += `${t} `)
  ...
  var Nt = M((sI, pf) => {
    ...
    function eb() {
      !Lr ||
        !tr ||
        ((Lr = !1),
        tr.length ? (_t = tr.concat(_t)) : (Ki = -1),
        _t.length && hf());
    }
    function hf() {
      if (!Lr) {
  ...
  var vt = M((_I, Ls) => {
    ...
    function jf(t, e, r) {
      ...
      let o = (i = e.readable) !== null && i !== void 0 ? i : ks(t),
        ...
        I = () => {
          ...
          if (o && !y && ks(t, !0) && !xf(t, !1)) return r.call(t, new kf());
  ...
  function Ws(t) {
    for (
      var e = t.length < 0 ? 0 : 0 | Gs(t.length), r = Et(e), i = 0;
      i < e;
      i += 1
    )
      r[i] = 255 & t[i];
  ...
  function hi(t) {
    ...
    (this.lastNeed = 0),
      (this.lastTotal = 0),
      (this.lastChar = Ks.allocUnsafe(e));
  }
  function $s(t) {
    return t <= 127
      ? 0
  ...
  var Rc,
    ...
    Ys = we(() => {
      ...
      for (
        ...
        ($e[sr] = on[sr]), (Oe[on.charCodeAt(sr)] = sr);
      ...
      (O.prototype.slice = function (t, e) {
        ...
        (O.prototype.readUInt16LE = function (t, e) {
          return (
            (t >>>= 0), e || be(t, 2, this.length), this[t] | (this[t + 1] << 8)
          );
        }),
        (O.prototype.readUInt16BE = function (t, e) {
          return (
            (t >>>= 0), e || be(t, 2, this.length), (this[t] << 8) | this[t + 1]
          );
        }),
        ...
        (O.prototype.readFloatLE = function (t, e) {
          return (
            (t >>>= 0), e || be(t, 4, this.length), Nr.read(this, t, !0, 23, 4)
          );
        }),
        (O.prototype.readFloatBE = function (t, e) {
          return (
            (t >>>= 0), e || be(t, 4, this.length), Nr.read(this, t, !1, 23, 4)
          );
        }),
        (O.prototype.readDoubleLE = function (t, e) {
          return (
            (t >>>= 0), e || be(t, 8, this.length), Nr.read(this, t, !0, 52, 8)
          );
        }),
        (O.prototype.readDoubleBE = function (t, e) {
          return (
            (t >>>= 0), e || be(t, 8, this.length), Nr.read(this, t, !1, 52, 8)
          );
        }),
      ...
      it.from && it.alloc && it.allocUnsafe && it.allocUnsafeSlow
        ? (an = ln)
        : (Ic(ln, an), (an.Buffer = ar)),
        (ar.prototype = Object.create(it.prototype)),
        Ic(it, ar),
        (ar.from = function (t, e, r) {
          if (typeof t == "number")
  ...
  var di = M((VT, Zc) => {
    ...
    F.prototype.pipe = function (t, e) {
      ...
      let o =
        (!e || e.end !== !1) && t !== He.stdout && t !== He.stderr ? a : S;
      i.endEmitted ? He.nextTick(o) : r.once("end", o), t.on("unpipe", s);
      function s(I, B) {
        H("onunpipe"),
          I === r && B && B.hasUnpiped === !1 && ((B.hasUnpiped = !0), h());
      }
      function a() {
        H("onend"), t.end();
      }
  ...
  var fo = M((XT, ch) => {
    ...
    ch.exports = ie;
    ie.WritableState = yi;
    var { EventEmitter: B_ } = (nr(), X(ir)),
      pi = tn().Stream,
      { Buffer: hn } = (ye(), X(_e)),
      gn = rr(),
      { addAbortSignal: P_ } = ci(),
      { getHighWaterMark: k_, getDefaultHighWaterMark: O_ } = sn(),
      {
    ...
    nh(ie, C_, {
      ...
      value: function (t) {
        return ih(this, t)
          ...
          : this !== ie
          ? !1
          : t && t._writableState instanceof yi;
      },
    });
      ...
      (r.writing = !1),
        ...
        e
          ? (e.stack,
            ...
            i ? fr.nextTick(th, t, r, e, n) : th(t, r, e, n))
            ...
            i
              ? r.afterWriteTickInfo !== null && r.afterWriteTickInfo.cb === n
                ...
                : ((r.afterWriteTickInfo = {
                  ...
                  fr.nextTick(F_, r.afterWriteTickInfo))
              : uh(t, r, 1, n));
    }
    ...
    function ao(t) {
      ...
      for (let n = t.bufferedIndex; n < t.buffered.length; ++n) {
        ...
        (t.length -= a),
          s((e = t.errored) !== null && e !== void 0 ? e : new gi("write"));
      }
      let r = t[Fr].splice(0);
    ...
    function lo(t, e) {
      ...
      if (((e.bufferProcessing = !0), o > 1 && t._writev)) {
        ...
        (l.allBuffers = e.allBuffers), eh(t, e, !0, e.length, l, "", a), pn(e);
      } else {
        do {
    ...
    ie.prototype.end = function (t, e, r) {
      ...
      return (
        ...
        typeof r == "function" &&
          (n || i.finished ? fr.nextTick(r, n) : i[Fr].push(r)),
        this
      );
    };
    function dn(t) {
  ...
  var Sh = M((s2, Eh) => {
    ...
    Eh.exports = function t(e, r) {
      ...
      if (typeof e == "function") {
        ...
        if (hh(n))
          return wh(cr, n, { objectMode: !0, write: o, final: s, destroy: a });
        let l = n?.then;
      ...
      if (hh(e)) return wh(cr, e, { objectMode: !0, writable: !1 });
      ...
      if (typeof i == "function") {
        ...
        return (
          ...
          (n = new cr({ objectMode: !0, writable: !1, read() {} }))
        );
      }
      throw new Y_(
        r,
  ...
  var mn = M((x2, Lh) => {
    ...
    function Mh(t, e, r) {
      ...
      function y(B, R) {
        if (
          (B && (!l || l.code === "ERR_STREAM_PREMATURE_CLOSE") && (l = B),
          !(!l && !R))
        ) {
          for (; h.length; ) h.shift()(l);
          o?.removeEventListener("abort", a),
            i.abort(),
            R && (l || s.forEach((U) => U()), wi.nextTick(e, l, c));
        }
      }
      let w;
      for (let B = 0; B < t.length; B++) {
        ...
        if (B === 0)
          ...
          if (((w = R(w, { signal: n })), U)) {
            if (!hr(w, !0))
              throw new vo("AsyncIterable", `transform[${B - 1}]`, w);
          } else {
            var S;
            Ao || (Ao = mo());
            ...
            else if (hr(w, !0)) d++, bn(w, z, g, { end: W });
            else if (So(w) || Hr(w)) {
              let pe = w.readable || w;
              d++, bn(pe, z, g, { end: W });
            } else throw new vo("AsyncIterable or Promise", "destination", w);
            w = z;
            let { destroy: de, cleanup: Qt } = xh(w, !1, !0);
  ...
  var Po = M((j2, Fh) => {
    ...
    Fh.exports = function (...e) {
      ...
      for (let y = 0; y < e.length; ++y)
        if (!(!En(e[y]) && !Bo(e[y]))) {
          if (y < e.length - 1 && !(Uh(e[y]) || Dh(e[y]) || dr(e[y])))
            throw new jh(`streams[${y}]`, r[y], "must be readable");
          if (y > 0 && !(Nh(e[y]) || qh(e[y]) || dr(e[y])))
      ...
      if (
        ...
        if (En(c))
          ...
          (a._write = async function (S, I, B) {
            try {
              await E.ready, E.write(S).catch(() => {}), B();
            } catch (R) {
              B(R);
            }
          }),
  ...
  var Qh = M((K2, xo) => {
    ...
    function K0(t, e) {
      if (
        (e != null && gr(e, "options"),
        e?.signal != null && pr(e.signal, "options.signal"),
        F0(t) && !j0(t))
      )
    ...
    function G0(t = void 0) {
      return (
        t != null && gr(t, "options"),
        t?.signal != null && pr(t.signal, "options.signal"),
        async function* () {
          let r = 0;
    ...
    async function Kh(t, e = void 0) {
      for await (let r of Oo.call(this, t, e)) return !0;
      return !1;
    }
    ...
    async function X0(t, e, r) {
      ...
      r != null && gr(r, "options"),
        r?.signal != null && pr(r.signal, "options.signal");
  ...
  var md = M((EC, _d) => {
    ...
    _();
    var Pm = fd(),
      { EventEmitter: km } = (nr(), X(ir)),
      wd = hd(),
      V = Wo(),
      D = ot()("mqtt-packet:parser"),
      $o = class t extends km {
        constructor() {
  ...
  var Id = M((UC, Ho) => {
    ...
    typeof C > "u" ||
    !C.version ||
    C.version.indexOf("v0.") === 0 ||
    (C.version.indexOf("v1.") === 0 && C.version.indexOf("v1.8.") !== 0)
  ...
  var Ko = M(($C, xd) => {
    ...
    Object.defineProperty(kd, "cacheNumbers", {
      get() {
        return Ie === zo;
      },
      set(t) {
    ...
    function Vm(t, e, r) {
      ...
      if (
        ((y += 1),
        (typeof c == "string" || q.isBuffer(c)) && (c || o >= 4) && (c || a))
      )
        y += q.byteLength(c) + 2;
      else {
        if (o < 4)
      ...
      return (
        ...
        o === 5 && w.write(),
        Gr(e, c),
        s && (o === 5 && E.write(), br(e, s.topic), Gr(e, s.payload)),
        h != null && Gr(e, h),
        d != null && Gr(e, d),
        !0
      );
    ...
    function Km(t, e, r) {
      ...
      if (
        (q.isBuffer(l) ? (d += l.length) : (d += q.byteLength(l)),
        o && typeof c != "number")
      )
    ...
    function Qm(t, e, r) {
      ...
      for (let g of a) {
        let y = g.topic,
          ...
          B;
        br(e, y),
          (B = j.SUBSCRIBE_OPTIONS_QOS[w]),
          i === 5 &&
            ((B |= E ? j.SUBSCRIBE_OPTIONS_NL : 0),
            (B |= S ? j.SUBSCRIBE_OPTIONS_RAP : 0),
            (B |= I ? j.SUBSCRIBE_OPTIONS_RH[I] : 0)),
          (d = e.write(q.from([B])));
      }
      return d;
    }
        ...
        for (let o in e) {
          ...
          if (Array.isArray(l))
            for (let c = 0; c < l.length; c++) {
              if (((a = i(o, l[c])), !a)) return !1;
              s += a;
            }
          else {
            if (((a = i(o, l)), !a)) return !1;
            s = a;
          }
          if (!s) return !1;
          r += s;
    ...
    function Bd(t, e, r) {
      ...
      for (let i in e)
        if (Object.prototype.hasOwnProperty.call(e, i) && e[i] !== null) {
          let n = e[i];
          if (Array.isArray(n))
            for (let o = 0; o < n.length; o++) Cd(t, i, n[o]);
          else Cd(t, i, n);
        }
    }
    function Od(t) {
  ...
  var Dd = M((bB, qd) => {
    ...
    function a1(t) {
      ...
      function e(n, o) {
        for (
          var s = Object.keys(n), a = new Array(s.length), l = 0;
          l < s.length;
          l++
        ) {
          var c = s[l],
    ...
    function l1(t) {
      ...
      function i(s, a) {
        for (
          var l = Object.keys(s), c = new Array(l.length), h = 0;
          h < l.length;
          h++
        ) {
          var d = l[h],
      ...
      function n(s) {
        ...
        e.push(s), r.push(a);
        for (var l in s)
          if (Object.hasOwnProperty.call(s, l) !== !1) {
            var c = s[l];
        ...
        if (t.options.protocolVersion === 5) {
          ...
          if ((e.properties && (l = e.properties.topicAlias), typeof l < "u"))
            if (i.length === 0)
              ...
              t.log("handlePublish :: topic alias out of range. alias: %d", l),
                t.emit(
                  "error",
                  new Error("Received Topic Alias is out of range")
                );
        ...
        switch ((t.log("handlePublish: qos %d", o), o)) {
          case 2: {
            a.customHandleAcks(i, n, e, (l, c) => {
              ...
              c
                ? t._sendPacket(
                    { cmd: "pubrec", messageId: s, reasonCode: c },
                    r
                  )
  ...
  var Jr = M((at) => {
    ...
    at.applyMixin = g1;
    at.nextTick =
      typeof (C === null || C === void 0 ? void 0 : C.nextTick) == "function"
        ? C.nextTick
        : (t) => {
            setTimeout(t, 0);
          };
    ...
    var y1 = (t, e) => {
      ...
      switch ((t.log("_handleAck :: packet type", i), i)) {
        ...
        case "puback": {
          let a = e.reasonCode;
          a && a > 0 && a !== 16
            ? ((s = new Error(`Publish error: ${$t.ReasonCodes[a]}`)),
              (s.code = a),
        ...
        case "suback": {
          ...
          for (let l = 0; l < a.length; l++) {
            let c = a[l];
            if (c & 128) {
              (s = new Error(`Subscribe error: ${$t.ReasonCodes[c]}`)),
                (s.code = c);
  ...
  var Zd = M((On) => {
    ...
    var _1 = (t) => !Yd.has(t),
      EP = Symbol("type"),
      Ht = (t) => t && t === Math.floor(t) && t > 0 && isFinite(t),
      Xd = (t) =>
        Ht(t)
          ? t <= Math.pow(2, 8)
            ? Uint8Array
      ...
      oa = class t {
        ...
        static unsafeExposeInternals(e) {
          return {
            ...
            backgroundFetch: (r, i, n, o) => e.#O(r, i, n, o),
            moveToTail: (r) => e.#C(r),
            indexes: (r) => e.#m(r),
            rindexes: (r) => e.#v(r),
            isStale: (r) => e.#d(r),
        ...
        constructor(e) {
          ...
          if (
            ...
            (this.ttlResolution = Ht(n) || n === 0 ? n : 1),
            (this.ttlAutopurge = !!o),
            (this.ttl = i || 0),
            this.ttl)
          ) {
        ...
        *rvalues() {
        ...
        set(e, r, i = {}) {
          ...
          if (
            (n !== 0 && !this.#w && this.#x(),
            this.#w && (c || this.#M(d, n, o), l && this.#A(l, d)),
            !s && this.#f && this.#o)
          ) {
            let g = this.#o,
              y;
        ...
        #k(e) {
          ...
          return (
            ...
            this.#R(r),
            e &&
              ((this.#r[r] = void 0), (this.#e[r] = void 0), this.#b.push(r)),
            this.#i === 1
        ...
        has(e, r = {}) {
          ...
          if (o !== void 0) {
            ...
            if (this.#d(o)) n && ((n.has = "stale"), this.#A(n, o));
              ...
              return i && this.#T(o), n && ((n.has = "hit"), this.#A(n, o)), !0;
          } else n && (n.has = "miss");
          return !1;
        }
        peek(e, r = {}) {
        ...
        #O(e, r, i, n) {
          ...
          let l = { signal: s.signal, options: i, context: n },
            c = (E, S = !1) => {
              let { aborted: I } = s.signal,
                B = i.ignoreFetchAbort && E !== void 0;
              if (
                (i.status &&
                  (I && !S
                    ? ((i.status.fetchAborted = !0),
                      (i.status.fetchError = s.signal.reason),
                      B && (i.status.fetchAbortIgnored = !0))
                ...
                this.#e[r] === y &&
                  (E === void 0
                    ...
                    : (i.status && (i.status.fetchUpdated = !0),
                      this.set(e, E, l.options))),
                E
              );
            },
            h = (E) => (
              i.status &&
                ((i.status.fetchRejected = !0), (i.status.fetchError = E)),
              d(E)
            ),
            d = (E) => {
              let { aborted: S } = s.signal,
                I = S && i.allowStaleOnFetchAbort,
                B = I || i.allowStaleOnFetchRejection,
                R = B || i.noDeleteOnFetchRejection,
                U = y;
              if (
                (this.#e[r] === y &&
            ...
            g = (E, S) => {
              ...
              I &&
                ...
                I.then((B) => E(B === void 0 ? void 0 : B), S),
                s.signal.addEventListener("abort", () => {
                  (!i.ignoreFetchAbort || i.allowStaleOnFetchAbort) &&
                    (E(void 0),
                    i.allowStaleOnFetchAbort && (E = (B) => c(B, !0)));
                });
            };
          ...
          return (
            r === void 0
              ? (this.set(e, w, { ...l.options, status: void 0 }),
                (r = this.#n.get(e)))
              : (this.#e[r] = w),
            w
          );
        ...
        #t(e) {
          ...
          return (
            ...
            r.__abortController instanceof kn
          );
        }
        async fetch(e, r = {}) {
          let {
                ...
                ? (s && (s.get = "stale"),
                  c
                    ? (s &&
                        ...
                        (s.returnedStale = !0),
                      i ? l.__staleWhileFetching : void 0)
                    : (o || this.delete(e),
                      s && i && (s.returnedStale = !0),
                      i ? l : void 0))
                : (s && (s.get = "hit"),
                  c ? l.__staleWhileFetching : (this.#C(a), n && this.#T(a), l))
            );
          } else s && (s.get = "miss");
        }
        #N(e, r) {
  ...
  var lt = M((Vt) => {
    ...
    m();
    _();
    Object.defineProperty(Vt, "t", { value: !0 });
      ...
      ya = class extends P1.default {
        ...
        find(e) {
          for (let r = 0; r < this.i; ++r)
            if (this.J[r] === e) return new wr(r, this);
          return this.end();
        }
        reverse() {
          this.J.reverse();
  ...
  var np = M((Wn) => {
    ...
    var mr = class t extends L1.ContainerIterator {
        ...
        get pointer() {
          return (
            this.o === this.h && (0, _r.throwIteratorAccessError)(), this.o.l
          );
        }
        set pointer(e) {
          this.o === this.h && (0, _r.throwIteratorAccessError)(),
    ...
    var ap = op(),
      ...
      ma = class extends W1.Container {
        ...
        updateKeyByIterator(e, r) {
          let i = e.o;
          if (
            (i === this.h && (0, lp.throwIteratorAccessError)(), this.i === 1)
          )
            return (i.u = r), !0;
          if (i === this.h.U)
  ...
  var fp = M((Gn) => {
    ...
    var Ke = class t extends K1.default {
        ...
        get pointer() {
          return (
            this.o === this.h && (0, G1.throwIteratorAccessError)(), this.o.u
          );
        }
        copy() {
          return new t(this.o, this.h, this.container, this.iteratorType);
  ...
  var ka = M((ei) => {
    ...
    var Pa = class extends dp.Container {
      ...
      eraseElementByIterator(e) {
        let r = e.o;
        return (
          r === this.h && (0, Ti.throwIteratorAccessError)(),
          this.V(r),
          e.next()
        );
      }
  ...
  var gp = M((Yn) => {
    ...
    var pp = ka(),
      ...
      Er = class t extends pp.HashContainerIterator {
        ...
        get pointer() {
          return (
            this.o === this.h && (0, rv.throwIteratorAccessError)(), this.o.u
          );
        }
        copy() {
          return new t(this.o, this.h, this.container, this.iteratorType);
  ...
  var mp = M((lx, _p) => {
    ...
    ht.prototype.use = function (t) {
      ...
      if (!r.equals(this.ss.end())) {
        ...
        return r.pointer.equals(e)
          ...
          ? !1
          : i === t
          ? (this.ss.updateKeyByIterator(r, new Te(i + 1, n)),
            ct("use():" + t),
            !0)
          : n === t
          ? (this.ss.updateKeyByIterator(r, new Te(i, n - 1)),
            ct("use():" + t),
            !0)
    ...
    ht.prototype.clear = function () {
      ct("clear()"),
        this.ss.clear(),
        this.ss.insert(new Te(this.min, this.max));
    };
        ...
        if (
          ...
          if (e.properties.topicAliasMaximum) {
            ...
            e.properties.topicAliasMaximum > 0 &&
              (t.topicAliasSend = new Iv.default(
  ...
  var Pi = M((Ar) => {
    ...
    var qv = () => {
        ...
        return typeof window < "u"
          ? typeof P < "u" &&
            ((t = P.userAgent) === null || t === void 0
              ? void 0
              : t.toLowerCase().indexOf(" electron/")) > -1 &&
            !(C === null || C === void 0) &&
            C.versions
            ? !Object.prototype.hasOwnProperty.call(C.versions, "electron")
            : typeof window.document < "u"
          : !1;
      },
      Dv = () => typeof P < "u" && P.userAgent === "txiki.js",
      Rp = () => {
        var t, e;
        return !!(
          typeof self == "object" &&
            ...
            y = function (S) {
              var I =
                  arguments.length > 1 && arguments[1] !== void 0
                    ? arguments[1]
                    : 0,
                B = e.generateUniqueNumber(a);
              return (
                a.set(B, function () {
                  S(),
                    typeof a.get(B) == "function" &&
                      h.postMessage({
                        id: null,
                        method: "set",
                        params: {
  ...
  var qp = M((Ct) => {
    ...
    var qa = $v(Pi()),
      Lp = Mp(),
      Up = { set: Lp.setInterval, clear: Lp.clearInterval },
      Np = { set: (t, e) => setInterval(t, e), clear: (t) => clearInterval(t) },
      Hv = (t) => {
        switch (t) {
          case "native":
            return Np;
          ...
          case "auto":
          default:
            return qa.default && !qa.isWebWorker && !qa.isReactNativeBrowser
              ? Up
              : Np;
        }
      };
  ...
  var ss = M((Qe) => {
    ...
    var Qv = zt(Gu()),
      ...
      ns = class t extends eE.TypedEventEmitter {
        static defaultId() {
        ...
        constructor(e, r) {
          ...
          for (let i in Wp)
            typeof this.options[i] > "u"
              ? (this.options[i] = Wp[i])
              : (this.options[i] = r[i]);
          (this.log = this.options.log || (0, Xv.default)("mqttjs:client")),
            ...
            this.options.writeCache ||
              (Fa.default.writeToStream.cacheNumbers = !1),
            ...
            r.properties &&
              ...
              (r.properties.topicAliasMaximum > 65535
                ...
                : (this.topicAliasRecv = new Qv.default(
        ...
        subscribe(e, r, i) {
          ...
          let l = { qos: 0 };
          n === 5 && ((l.nl = !1), (l.rap = !1), (l.rh = 0)),
            (r = Object.assign(Object.assign({}, l), r));
          let c = r.properties,
            h = [],
            d = (y, w) => {
              if (
          ...
          if (
            (Array.isArray(e)
              ...
              : Object.keys(e).forEach((y) => {
                  this.log("subscribe: object topic %s, %o", y, e[y]),
                    d(y, e[y]);
                }),
            !h.length)
          )
        ...
        reconnect(e) {
          ...
          let r = () => {
            e
              ...
              (this.incomingStore =
                this.options.incomingStore || new rs.default()),
              (this.outgoingStore =
                this.options.outgoingStore || new rs.default()),
              (this.disconnecting = !1),
              (this.disconnected = !1),
        ...
        _setupKeepaliveManager() {
          this.log(
            ...
            !this.keepaliveManager &&
              this.options.keepalive &&
              (this.keepaliveManager = new tE.default(
                this,
  ...
  var Hp = M((Ha) => {
    ...
    var rE = Ma(),
      $a = class {
        constructor() {
          this.numberAllocator = new rE.NumberAllocator(1, 65535);
        }
        allocate() {
    ...
    Jp = we(() => {
      ...
      (zp = function (t, e) {
        ...
        (Kp = function (t) {
          ...
          s < 0 && (s = 0);
          for (let l = 0; l < s; ++l)
            t.charCodeAt(l) >= 128 && Ir("not-basic"), e.push(t.charCodeAt(l));
          for (let l = s > 0 ? s + 1 : 0; l < r; ) {
            let c = i;
            for (let d = 1, g = 36; ; g += 36) {
              l >= r && Ir("invalid-input");
              let y =
                (a = t.charCodeAt(l++)) - 48 < 10
                  ? a - 22
                  : a - 65 < 26
                  ? a - 65
                  : a - 97 < 26
        ...
        (Gp = function (t) {
          ...
          for (s && e.push("-"); a < r; ) {
            ...
            let c = a + 1;
            l - i > dt((2147483647 - n) / c) && Ir("overflow"),
              (n += (l - i) * c),
              (i = l);
            for (let h of t)
        ...
        (Kt = {
          ...
          toASCII: function (t) {
            return Vp(t, function (e) {
              return nE.test(e) ? "xn--" + Gp(e) : e;
            });
          },
          toUnicode: function (t) {
            return Vp(t, function (e) {
              return iE.test(e) ? Kp(e.slice(4).toLowerCase()) : e;
            });
          },
        });
      Kt.decode;
                  ...
                  .map(function (n) {
                    ...
                    return Array.isArray(t[n])
                      ? t[n]
                          ...
                          .join(e)
                      : o + encodeURIComponent(Oi(t[n]));
                  })
                  .join(e)
              : i
              ? encodeURIComponent(Oi(i)) + r + encodeURIComponent(Oi(t))
              : ""
          );
        }),
        (pt = {});
      (pt.decode = pt.parse = lE), (pt.encode = pt.stringify = uE);
      pt.decode;
      pt.encode;
      pt.parse;
      pt.stringify;
  ...
  function fE() {
    ri &&
      Tr &&
      ((ri = !1),
      Tr.length ? (Ot = Tr.concat(Ot)) : (os = -1),
      Ot.length && rg());
  }
  function rg() {
    if (!ri) {
  ...
  function cE() {
    ...
    function d() {
      !l ||
        !c ||
        ((l = !1), c.length ? (a = c.concat(a)) : (h = -1), a.length && g());
    }
    function g() {
      if (!l) {
        var E = o(d);
  ...
  function hE() {
    ...
    function i(o, s) {
      var a = s.dir || s.root,
        l = s.base || (s.name || "") + (s.ext || "");
      return a ? (a === s.root ? a + l : a + o + l) : l;
    }
    var n = {
      resolve: function () {
        for (
          var s = "", a = !1, l, c = arguments.length - 1;
          c >= -1 && !a;
          c--
        ) {
          var h;
      ...
      relative: function (s, a) {
        ...
        for (
          var c = s.length, h = c - l, d = 1;
          d < a.length && a.charCodeAt(d) === 47;
          ++d
        );
        for (
          var g = a.length, y = g - d, w = h < y ? h : y, E = -1, S = 0;
          S <= w;
          ++S
        ) {
          if (S === w) {
            if (y > w) {
              ...
              h > w &&
                (s.charCodeAt(l + S) === 47 ? (E = S) : S === 0 && (E = 0));
            break;
          }
          var I = s.charCodeAt(l + S),
            B = a.charCodeAt(d + S);
          if (I !== B) break;
          I === 47 && (E = S);
        }
      ...
      extname: function (s) {
        e(s);
        for (
          var a = -1, l = 0, c = -1, h = !0, d = 0, g = s.length - 1;
          g >= 0;
          --g
        ) {
      ...
      parse: function (s) {
        ...
        c ? ((a.root = "/"), (h = 1)) : (h = 0);
        for (
          var d = -1, g = 0, y = -1, w = !0, E = s.length - 1, S = 0;
          E >= h;
          --E
        ) {
  ...
  function xE(t) {
    ...
    if (((r = r.replace(TE, "\\")), (r = decodeURIComponent(r)), e !== ""))
      return `\\\\${e}${r}`;
    {
  ...
  function LE(t) {
    ...
    (r === SE || (rl && r === EE)) && e[e.length - 1] !== cg.sep && (e += "/");
    let i = new URL("file://");
    return (
      e.includes("%") && (e = e.replace(RE, "%25")),
      !rl && e.includes("\\") && (e = e.replace(CE, "%5C")),
      e.includes(`
`) && (e = e.replace(BE, "%0A")),
      e.includes("\r") && (e = e.replace(PE, "%0D")),
      e.includes("	") && (e = e.replace(kE, "%09")),
      (i.pathname = e),
      i
    );
  }
  ...
  function ZE(t) {
    ...
    if (((r = r.replace(KE, "\\")), (r = decodeURIComponent(r)), e !== ""))
      return `\\\\${e}${r}`;
    {
      let i = r.codePointAt(1) | 32,
        n = r[2];
  ...
  function dg(t) {
    let e = Ja.resolve(t),
      r = t.charCodeAt(t.length - 1);
    (r === HE || (il && r === $E)) && e[e.length - 1] !== Ja.sep && (e += "/");
    let i = new URL("file://");
    return (
      e.includes("%") && (e = e.replace(GE, "%25")),
      !il && e.includes("\\") && (e = e.replace(QE, "%5C")),
      e.includes(`
`) && (e = e.replace(YE, "%0A")),
      e.includes("\r") && (e = e.replace(JE, "%0D")),
      e.includes("	") && (e = e.replace(XE, "%09")),
      (i.pathname = e),
      i
    );
  }
...
`,
      ...
      (Fe.prototype.parse = function (t, e, r) {
        ...
        if (r || l || s.match(/^\/\/[^@\/]+@[^@\/]+/)) {
          var h = s.substr(0, 2) === "//";
          !h || (l && Xa[l]) || ((s = s.substr(2)), (this.slashes = !0));
        }
        if (!Xa[l] && (h || (l && !si[l]))) {
          for (var d, g, y = -1, w = 0; w < lg.length; w++)
            (E = s.indexOf(lg[w])) !== -1 && (y === -1 || E < y) && (y = E);
          for (
            (g = y === -1 ? s.lastIndexOf("@") : s.lastIndexOf("@", y)) !==
              -1 &&
              ((d = s.slice(0, g)),
              (s = s.slice(g + 1)),
          ...
          if (!S)
            for (
              var I = this.hostname.split(/\./), B = ((w = 0), I.length);
              w < B;
              w++
            ) {
              var R = I[w];
          ...
          this.hostname.length > 255
            ...
            S || (this.hostname = dE.toASCII(this.hostname));
        ...
        (Fe.prototype.resolveObject = function (t) {
          ...
          for (
            var r = new Fe(), i = Object.keys(this), n = 0;
            n < i.length;
            n++
          ) {
            var o = i[n];
    ...
    var rS = yg((sl(), X(nl))),
      ...
      sS = (t, e) => {
        ...
        let { port: r, path: i } = e,
          n = e.hostname;
        return (
          nS("port %d and host %s", r, n),
          rS.default.createConnection({ port: r, host: n, path: i })
        );
      };
    Mi.default = sS;
  });
  ...
  var ll = M((Li) => {
    ...
    var aS = al((wg(), X(bg))),
      lS = al((sl(), X(nl))),
      uS = al(ot()),
      fS = (0, uS.default)("mqttjs:tls"),
      cS = (t, e) => {
        (e.port = e.port || 8883),
          (e.host = e.hostname || e.host || "localhost"),
          lS.default.isIP(e.host) === 0 && (e.servername = e.host),
  ...
  var as = M((oi) => {
    ...
    oi.writev = mg;
    var ul = class extends hS.Duplex {
      constructor(e, r, i) {
        super({ objectMode: !0 }),
          (this.proxy = r),
          (this.socket = i),
  ...
  var hl = M((cl) => {
    ...
    var _S = (t, e) => {
      ...
      (yt = wx.connectSocket({ url: i, protocols: [r] })),
        (fl = gS()),
        (Le = new pS.BufferedDuplex(e, fl, yt)),
        (Le._destroy = (o, s) => {
          yt.close({
            success() {
              s && s(o);
  ...
  var gl = M((pl) => {
    ...
    var TS = (t, e) => {
      ...
      return (
        ...
        (ls = ES()),
        (ai = new vS.BufferedDuplex(e, ls, xt)),
        IS(),
        ai
      );
    };
  ...
  var _l = M((Ui) => {
    ...
    var yl = (ye(), X(_e)),
      ...
      Tg = wl(Pi()),
      bl = as(),
      Gt = (0, RS.default)("mqttjs:ws"),
      BS = ["rejectUnauthorized", "ca", "cert", "key", "pfx", "passphrase"];
    function Rg(t, e) {
    ...
    function kS(t, e, r) {
      Gt("createWebSocket"),
        Gt(`protocol: ${r.protocolId} ${r.protocolVersion}`);
      let i =
    ...
    var xS = (t, e) => {
      ...
      MS = (t, e) => {
        ...
        let r,
          ...
          a = OS(t, e),
          l = h(e, E, S);
        e.objectMode || (l._writev = bl.writev.bind(l)),
          l.on("close", () => {
            a.close();
          });
        ...
        function h(I, B, R) {
          let U = new CS.Transform({ objectMode: I.objectMode });
          return (U._write = B), (U._flush = R), U;
        }
        function d() {
          Gt("WebSocket onOpen"),
            r instanceof bl.BufferedDuplex && r.socketReady();
        }
        function g(I) {
  ...
  var kg = M((Rr) => {
    ...
    var LS = us(ot()),
      ...
      qS = us(Pi());
    typeof (C === null || C === void 0 ? void 0 : C.nextTick) != "function" &&
      (C.nextTick = setImmediate);
    var Bg = (0, LS.default)("mqttjs"),
      Re = {};
    qS.default
      ? ((Re.wx = hl().default),
        (Re.wxs = hl().default),
    ...
    function Pg(t, e) {
      ...
      if (
        ...
        let l = US.default.parse(t, !0),
          c = {};
        if (
          (l.port != null && (c.port = Number(l.port)),
          (c.host = l.hostname),
          (c.query = l.query),
          (c.auth = l.auth),
      ...
      if (
        ((e.unixSocket =
          e.unixSocket ||
          ((i = e.protocol) === null || i === void 0
            ? void 0
            : i.includes("+unix"))),
        e.unixSocket
          ? (e.protocol = e.protocol.replace("+unix", ""))
          : !(
              !((n = e.protocol) === null || n === void 0) && n.startsWith("ws")
            ) &&
            !(
              !((o = e.protocol) === null || o === void 0) && o.startsWith("wx")
            ) &&
            delete e.path,
        DS(e),
        e.query &&
      ...
      if (!Re[e.protocol]) {
        ...
        e.protocol = [
          ...
          l && h % 2 === 0 ? !1 : typeof Re[c] == "function"
        )[0];
      }
      ...
      function s(l) {
        return (
          e.servers &&
            ((!l._reconnectCount || l._reconnectCount === e.servers.length) &&
              (l._reconnectCount = 0),
            (e.host = e.servers[l._reconnectCount].host),
            (e.port = e.servers[l._reconnectCount].port),
            (e.protocol = e.servers[l._reconnectCount].protocol
              ? e.servers[l._reconnectCount].protocol
              : e.defaultProtocol),
            (e.hostname = e.host),
            l._reconnectCount++),
